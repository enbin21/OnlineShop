$(function () {
    var IMP = window.IMP; // iamport 메뉴얼 참고
    IMP.init('imp28283072'); // iamport 관리자 페이지에 있는 가맹점 식별코드를 입력해야 함
    ...
    $('.order-form').on('submit', function (e) { // order_form에 submit 버튼을 눌렀을 때 function을 동작시킴
        ...
        if (merchant_id !== '') { // !==: type까지 같은지 체크
            ...
            IMP.request_pay({ // 결제 요청 부분, iamport 메뉴얼에서 정의해준 포맷맷
                merchat_uid: merchant_id,
                name: 'E-Shop product',
